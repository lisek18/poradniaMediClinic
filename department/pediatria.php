...
<head>
  <meta charset="UTF-8" />
  <title>Pediatria – MediClinic</title>
...
<section class="hero-ortopedia" style="background-image: url('/poradnia/image/pediatria.jpg')">
  <div class="overlay"></div>
  <div class="container hero-content">
    <h1>Poradnia Pediatryczna</h1>
  </div>
</section>
...
<section class="section">
  <div class="container">
    ...
    <table class="pricing-table">
      ...
      <tbody>
        <?php
          $result = $mysqli->query("SELECT * FROM pediatria_services");
