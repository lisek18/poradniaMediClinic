...
<head>
  <meta charset="UTF-8">
  <title>Dermatologia – MediClinic</title>
...
<?php include '../includes/header.php'; ?>
  ...
  <section class="hero-ortopedia" style="background-image: url('/poradnia/image/dermatologia.jpg')">
    <div class="overlay"></div>
    <div class="container hero-content">
      <h1>Poradnia Dermatologiczna</h1>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      ...
      <table class="pricing-table">
        ...
        <tbody>
        <?php
          $result = $mysqli->query("SELECT * FROM dermatologia_services");
