...
<head>
  <meta charset="UTF-8">
  <title>Kardiologia – MediClinic</title>
...
<section class="hero-ortopedia" style="background-image: url('/poradnia/image/kardiologia.jpg')">
  <div class="overlay"></div>
  <div class="container hero-content">
    <h1>Poradnia Kardiologiczna</h1>
  </div>
</section>
...
<section class="section">
  <div class="container">
    ...
    <table class="pricing-table">
      ...
      <tbody>
      <?php
        $result = $mysqli->query("SELECT * FROM kardiologia_services");
