...
<head>
  <meta charset="UTF-8" />
  <title>Okulistyka – MediClinic</title>
...
<section class="hero-ortopedia" style="background-image: url('/poradnia/image/okulistyka.jpg')">
...
<section class="section">
  <div class="container">
    ...
    <table class="pricing-table">
      ...
      <tbody>
        <?php
        $res = $mysqli->query("SELECT * FROM okulistyka_services");
